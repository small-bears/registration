					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							...
							<div class="layui-input-block input">
								<input type="text"  name="keshimingcheng" name="keshimingcheng" id="keshimingcheng" placeholder="科室名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">科室类型</label>
							<div class="layui-input-block input">
								<input type="text"  name="keshileixing" name="keshileixing" id="keshileixing" placeholder="科室类型" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item" :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							...
							<div class="layui-input-block input">
								<input type="text"  name="keyuerenshu" name="keyuerenshu" id="keyuerenshu" placeholder="可约人数" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							...
							<div class="layui-input-block date">
								<input type="text" name="shangbanriqi"  id="shangbanriqi" placeholder="上班日期" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							...
							<div class="layui-input-block">
								<img id="keshitupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :style='{"boxShadow":"0 0 6px rgba(156,187,252,0)","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"1px","width":"80px","borderStyle":"solid","height":"80px"}' src="../../img/avator.png">
								<input type="hidden" id="keshitupian" name="keshitupian" />
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							...
							<div class="layui-input-block">
								<button :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 10px 0 0","borderColor":"#ccc","backgroundColor":"rgba(156, 187, 252, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="button" class="layui-btn btn-theme" id="keshitupianUpload">
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function() {
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					// 图片赋值
					jquery("#keshitupianImg").attr("src", http.baseurl+data.data.keshitupian);
				});
