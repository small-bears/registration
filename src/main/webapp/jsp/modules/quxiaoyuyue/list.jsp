...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">取消预约管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>取消预约管理</span></li>
								<li class="breadcrumb-item active"><span>取消预约列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">取消预约列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('quxiaoshijian')">取消时间<i id="quxiaoshijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('quxiaoyuanyin')">取消原因<i id="quxiaoyuanyinIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var quxiaoshijianCell  = document.createElement('td');

						  quxiaoshijianCell.innerHTML = item.quxiaoshijian;


			row.appendChild(quxiaoshijianCell);
			var quxiaoyuanyinCell  = document.createElement('td');

						 quxiaoyuanyinCell.innerHTML = item.quxiaoyuanyin;

			row.appendChild(quxiaoyuanyinCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("quxiaoyuyue/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("quxiaoyuyue/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("quxiaoyuyue/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"quxiaoyuyue");
