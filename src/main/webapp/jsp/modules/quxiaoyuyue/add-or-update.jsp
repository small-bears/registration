...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑取消预约</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑取消预约</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">取消预约信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>医生工号</label>
										<input name="yishenggonghao" id="yishenggonghao" name="yishenggonghao" class="form-control" placeholder="医生工号">
									</div>
									<div class="form-group col-md-6">
										<label>医生姓名</label>
									...
									<div class="form-group col-md-6">
										<label>取消时间</label>
										<div id="quxiaoshijianDate" class="input-append date form_datetime">
											<input id="quxiaoshijian-input" name="quxiaoshijian" size="20" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>取消原因</label>
										<input name="quxiaoyuanyin" id="quxiaoyuanyin" name="quxiaoyuanyin" class="form-control" placeholder="取消原因">
									</div>
									<div class="form-group col-md-6">
										<label>账号</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "quxiaoyuyue/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("quxiaoyuyue/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("quxiaoyuyue/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dateTimePick(){
			...
			$("#quxiaoshijian-input").val(getCurDateTime());
			$("#quxiaoshijianDate").datetimepicker({ 
				autoclose: true,
		...
		function dataBind(){
			...
			$("#quxiaoshijian-input").val(ruleForm.quxiaoshijian);
			$("#quxiaoyuanyin").val(ruleForm.quxiaoyuanyin);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yishenggonghao != null && res.data.yishenggonghao != ''){
						...
						$("#yishenggonghao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.quxiaoshijian != null && res.data.quxiaoshijian != ''){

						$("#quxiaoshijian-input").val(res.data.quxiaoshijian);
						$('#quxiaoshijianFileName').val(res.data.quxiaoshijian)
					}
					if(res.data != null && res.data != '' && res.data.quxiaoyuanyin != null && res.data.quxiaoyuanyin != ''){

						$("#quxiaoyuanyin").val(res.data.quxiaoyuanyin);
						$("#quxiaoyuanyin").attr('readonly','readonly');
					}
