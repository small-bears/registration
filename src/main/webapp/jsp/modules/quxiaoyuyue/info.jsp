						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="quxiaoshijian" name="quxiaoshijian" class="form-control" v-model="ruleForm.quxiaoshijian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>取消原因</label>

									<input id="quxiaoyuanyin" name="quxiaoyuanyin" class="form-control" v-model="ruleForm.quxiaoyuanyin" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>账号</label>
