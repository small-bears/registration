						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="keshileixing" name="keshileixing" class="form-control" v-model="ruleForm.keshileixing" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>医生工号</label>
									...
									<input id="shangbanriqi" name="shangbanriqi" class="form-control" v-model="ruleForm.shangbanriqi" readonly>
									</div>
									...
									<img id="keshitupianImg" src="" width="100" height="100">
									</div>
									...
									<div class="form-group  col-md-12">
										<label>排班表</label>
										<script id="paibanbiaoEditor" type="text/plain" style="width:800px;height:230px;"></script>
									...
									<div class="form-group  col-md-12">
										<label>医生介绍</label>
										<script id="yishengjieshaoEditor" type="text/plain" style="width:800px;height:230px;"></script>
										<script type="text/javascript">
										    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
										   //相见文档配置属于你自己的编译器
