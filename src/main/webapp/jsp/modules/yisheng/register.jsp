...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20220404/bf06161dcf3e4733a4e6d4de3e7b6f8a.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">医生工号</label> 
							<input  name="yishenggonghao" placeholder="医生工号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="keshi" placeholder="科室" class="form-control-i">
							</div>
							<div class="form-group">
