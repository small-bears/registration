...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yuyueshuoming')">预约说明<i id="yuyueshuomingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yuyueshuomingCell  = document.createElement('td');

						 yuyueshuomingCell.innerHTML = item.yuyueshuoming;

			row.appendChild(yuyueshuomingCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "取消预约"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'quxiaoyuyue','是','[1]','已取消')");
			if(crossBtnControl('取消预约') == true){
				btnGroup.appendChild(crossBtn0);
			}   
			var crossBtn1 = document.createElement('button');
            		crossBtn1.innerHTML = "改约通知"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'gaiyuetongzhi','是','','')");
			if(crossBtnControl('改约通知') == true){
